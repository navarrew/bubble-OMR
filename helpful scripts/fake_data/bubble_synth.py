...
# -*- coding: utf-8 -*-
"""
bubble_synth_patched.py

Adds DPI control, output format (png/jpg), JPEG quality, dpi-tagged saves,
and PDF assembly via img2pdf with exact Letter page size.
"""
...
BUBBLE_RGBA = (100,100,100,150)  #Soft, light-opacity dark grey
